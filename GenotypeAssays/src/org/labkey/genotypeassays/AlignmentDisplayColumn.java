...
public class AlignmentDisplayColumn extends DataColumn
{
    ...
    public void renderGridCellContents(RenderContext ctx, Writer out) throws IOException
    {
        ...
        if (key != null)
        {
            out.write("<a class=\"labkey-text-link\" style=\"max-width: 500px;\" onclick=\"GenotypeAssays.window.EditAlignmentsWindow.editRow(" + PageFlowUtil.jsString(key.toString()) + ", " + PageFlowUtil.jsString(ctx.getCurrentRegion().getName()) + ", arguments[0], arguments[1], arguments[2]);\">");
    ...
    {
        return PageFlowUtil.set(ClientDependency.fromPath("SequenceAnalysis/sequenceAnalysis"), ClientDependency.fromPath("genotypeassays/window/EditAlignmentsWindow.js"));
    }
}

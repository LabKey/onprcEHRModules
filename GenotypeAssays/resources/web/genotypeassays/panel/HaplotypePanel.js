        ...
        Ext4.apply(this, {
            ...
            items: [{
                ...
                columns: [{
                    ...
                    width: 200,
                    renderer: function (value, cellMetaData, record, rowIndex, colIndex, store) {
                        return GenotypeAssays.panel.HaplotypePanel.lineageColRenderer(record, '1');
                    }
                },{
                    header: 'Omit?',
                    xtype: 'checkcolumn',
                    ...
                    width: 200,
                    renderer: function (value, cellMetaData, record, rowIndex, colIndex, store) {
                        return GenotypeAssays.panel.HaplotypePanel.lineageColRenderer(record, '2');
                    }
                },{
                    header: 'Omit?',
                    xtype: 'checkcolumn',
        ...
        multi.add(LABKEY.Query.selectRows, {
            ...
            success: function(results){
                ...
                Ext4.Array.forEach(results.rows, function(row){
                    ...
                    this.haplotypes[row['haplotype/type']][row.haplotype] = this.haplotypes[row['haplotype/type']][row.haplotype] || GenotypeAssays.panel.HaplotypePanel.Haplotype(row.haplotype, row['haplotype/type'], row['haplotype/type/sort_order'], row['haplotype/color']);
            ...
            return {
                ...
                getMatch: function(lineagesFromAnalysis, lineageToAlleleMap){
                    ...
                    if (!hasRequired || Ext4.isEmpty(matchMap)){
                        ...
                        return GenotypeAssays.panel.HaplotypePanel.HaplotypeMatch(this, matchMap);
                    }
                }
            }
        },

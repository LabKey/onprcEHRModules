...
SELECT core.fn_dropifexists('p_ComplianceAccesscontainerUpdate', 'onprc_ehr_compliancedb', 'PROCEDURE', NULL);
...
SELECT core.fn_dropifexists('p_ComplianceRecentOverDueSoon_Process', 'onprc_ehr_compliancedb', 'PROCEDURE', NULL);
...
SELECT core.fn_dropifexists('p_ComplianceProcedureOverDueSoon_Process', 'onprc_ehr_compliancedb', 'PROCEDURE', NULL);
...
**
** 	Created by
**      Blasa  		9-5-2025               Stored procedure to update Compliance Access container values and update
...
-- TODO: Delete this? On PostgreSQL, all GUIDs are lowercase, so this probably won't ever match. But it also looks like
-- a one-time fix-up that probably ran long ago on the production DB.

...
BEGIN
        ...
        select b.requirementname,
               ...
               (select top 1 h.trackingflag from ehr_compliancedb.requirementspercategory h where h.requirementname = b.requirementname and (h.unit =a.unit or h.category =a.category) ) as trackingflag,

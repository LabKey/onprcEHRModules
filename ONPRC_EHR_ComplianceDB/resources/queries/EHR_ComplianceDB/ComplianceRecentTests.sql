...
select b.requirementname,
     ...
     (select
        ...
        END AS double)  from completiondates pq, requirements Tr where pq.requirementname = b.requirementname And Tr.requirementname = pq.requirementname group by tr.expireperiod)

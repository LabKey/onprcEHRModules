...
select b.requirementname,
       ...
       (Select yy.snooze_date from completiondates yy where yy.date in (select max(zz.snooze_date) from completiondates zz where zz.requirementname= b.requirementname and zz.employeeid= a.employeeid )
                                                                                     And  yy.requirementname= b.requirementname and yy.employeeid= a.employeeid   ) as snoozedate,
...
select a.requirementname,
       ...
       (Select yy.snooze_date  from completiondates yy where yy.date in (select max(zz.snooze_date) from completiondates zz where zz.requirementname= a.requirementname and zz.employeeid= a.employeeid )
                                                                                     And  yy.requirementname= a.requirementname and yy.employeeid= a.employeeid   ) as snoozedate,

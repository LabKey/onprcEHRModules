...
public class GeneticsCoreModule extends ExtendedSimpleModule
{
    ...
    protected void doStartupAfterSpringConfig(ModuleContext moduleContext)
    {
        ...
        btn1.setClientDependencies(ClientDependency.supplierFromModuleName("laboratory"), ClientDependency.supplierFromModuleName("ehr"), ClientDependency.supplierFromPath("geneticscore/window/ManageFlagsWindow.js"), ClientDependency.supplierFromPath("geneticscore/buttons.js"));
        ...
        LaboratoryService.get().registerDataProvider(new GeneticsCoreDataProvider());
    }

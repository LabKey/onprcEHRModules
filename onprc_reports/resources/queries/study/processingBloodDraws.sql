SELECT
 ...
 (coalesce(s.CChembloodVol1,0) + coalesce(s.CChembloodVol2,0) + coalesce(s.CChembloodVol3,0) + coalesce(s.CChembloodVol4,0) )  as CompChemBloodVol,
 (coalesce(s.BChembloodVol1,0) )  as BasicChemBloodVol,

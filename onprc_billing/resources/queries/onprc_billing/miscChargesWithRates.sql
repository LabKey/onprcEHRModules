...
SELECT
  ...
  p.chargetype,
  p.chargeId,
  p.chargeId.rowid as Charge_ID,
  cr.chargeID.activeRate.subsidy as subsidy,
  p.project.project as ProjectID,
  ...
  p.createdby,
  p.taskId,
  alias.aliasType.removeSubsidy as removeSubsidy,
  pm.multiplier as PM_Multiplier,
  alias.aliasType.canRaiseFA  as canRaiseFa,

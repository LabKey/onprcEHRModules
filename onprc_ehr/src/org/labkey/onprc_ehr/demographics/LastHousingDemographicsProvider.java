...
public class LastHousingDemographicsProvider extends AbstractListDemographicsProvider
{
    public LastHousingDemographicsProvider(Module module)
    {
        super(module, "study", "LastHousingLocation", "lastlocation");

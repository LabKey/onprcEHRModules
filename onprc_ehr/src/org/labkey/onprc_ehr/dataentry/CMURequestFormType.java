...
//Created: 11-4-2024 R.blasa
public class CMURequestFormType extends RequestForm
{
    public static final String NAME = "CMU Services Request";
    public static final String DEFAULT_GROUP = "CMU Services";

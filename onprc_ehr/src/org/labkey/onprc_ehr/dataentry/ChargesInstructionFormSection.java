...
public class ChargesInstructionFormSection extends AbstractFormSection
{
    ...
    {
        super("ChargesInstruction", "Instructions", "onprcehr-chargesinstructionpanel");

        addClientDependency(ClientDependency.fromFilePath("onprc_ehr/panel/ChargesInstructionPanel.js"));
    }

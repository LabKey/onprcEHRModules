 ...
 */
public class ONPRC_EHRCMUAdministrationRole extends AbstractRole
{
    public ONPRC_EHRCMUAdministrationRole()
    {
        super("ONPRC EHR CMU Administration", "This role is to track which users can edit the table onprc_ehr vetassignments.",
                ReadPermission.class,
                InsertPermission.class,
                UpdatePermission.class,
                DeletePermission.class,
                ONPRC_EHRCustomerEditPermission.class,
                ONPRC_EHRCMUAdministrationPermission.class
        );
    }
    @Override

...
public class CreateNecropsyRequestButton extends CreateTaskFromRecordsButton
{
    ...
    {
        super(owner, "Create Necropsy Request From Selected", "ONPRC_EHR.window.CreateNecropsyRequestWindow.createTaskFromRecordHandler(dataRegionName, '" + PathologyTissuesFormType.NAME + "')");

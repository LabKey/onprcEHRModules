...
//        Modified: 2-20-2020 R. Blasa
    ...
    protected void dcmNotesAlert(final Container c, User u, final StringBuilder msg)
    {
        ...
        if (count > 0)
        {
            ...
            msg.append("<p><a href='" + getExecuteQueryUrl(c, "study", "Notes_WithLocation", null) + "&query.date~dateeq="+ getDateTimeFormat(c).format(new Date()) + "&query.category~eq=Notes Pertaining to DAR'>Click here to view them</a><br>\n\n");
            msg.append("</p><br><hr>");
        }
        else
        {

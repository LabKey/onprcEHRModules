...
{
    public ProjectAlertsNotification(Module owner)
    {
        super(owner);
    }
    ...
    {
        return "Center Project Notification";
    }

    @Override
    public String getEmailSubject(Container c)
    {
        return "Project Alerts Notification: " + DateUtil.formatDateTime(c);
    }
    ...
    {
        return "The report sends an alert whenever a new  Center Project record is created.";
    }

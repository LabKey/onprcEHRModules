    ...
    public void findAbnormalResults(Container c, User u, StringBuilder msg, Date lastRun)
    {
        ...
        try
        {
            ...
            if (rs.next())
            {
                ...
                msg.append("<p><a href='" + _baseUrl + "/executeQuery.view?schemaName=study&query.queryName=ClinpathRefRange&query.taskid/datecompleted~gte=" + AbstractEHRNotification._dateTimeFormat.format(lastRun) + "&query.taskid/datecompleted~nonblank&query.qcstate/PublicData~eq=true'>Click here to view them</a><p>\n");

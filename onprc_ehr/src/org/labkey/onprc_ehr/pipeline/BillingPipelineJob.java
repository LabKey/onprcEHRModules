...
import org.labkey.onprc_ehr.ONPRC_EHRController;
...
public class BillingPipelineJob extends PipelineJob implements BillingPipelineJobSupport
{
    ...
    private ONPRC_EHRController.BillingPipelineForm _form;

    public BillingPipelineJob(Container c, User user, ActionURL url, PipeRoot pipeRoot, File analysisDir, ONPRC_EHRController.BillingPipelineForm form)
    {

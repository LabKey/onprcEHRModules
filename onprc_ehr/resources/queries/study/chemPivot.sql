...
(SELECT
  ...
  --Updated 6-3-2015 Blasa
  GROUP BY d.runid,d.id, d.date, d.method) grp

ON pivot_.runId = grp.runId AND pivot_.id = grp.id AND pivot_.date = grp.date AND pivot_.method = grp.method

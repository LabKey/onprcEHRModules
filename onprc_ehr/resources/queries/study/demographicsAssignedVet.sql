...
Select
    ...
    Case
        ...
        WHen s7.userID is not null then  'Project Research High Priority'
        When s8.userID is not null then 'Project Resource HighPriority'
        ...
        --  when v5.userId is not null then  'Protocol High Priority'

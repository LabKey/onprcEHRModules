...
var Security = require("ehr/security").EHR.Server.Security;

var billingHelper = new org.labkey.onprc_ehr.billing.BillingTriggerHelper(LABKEY.Security.currentUser.id, LABKEY.Security.currentContainer.id);
...
exports.init = function(EHR){
    ...
    EHR.Server.TriggerManager.registerHandlerForQuery(EHR.Server.TriggerManager.Events.AFTER_UPSERT, 'study', 'Clinpath Runs', function(helper, scriptErrors, row, oldRow){
        console.log('inspecting clinpath runs record for billing audit');

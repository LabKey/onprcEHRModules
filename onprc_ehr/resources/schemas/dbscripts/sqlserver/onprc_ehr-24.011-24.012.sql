...
/****** Object:  StoredProcedure [audit].[ArchiveAuditTables_Update]    Script Date: 7/3/2025 8:19:52 AM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    ...
    BEGIN
        ...
        CREATE TABLE audit.ArchiveAuditLog (
    ...
    WHILE @@FETCH_STATUS = 0
        ...
        SELECT @LogIDOUT = SCOPE_IDENTITY();';
            ...
            UPDATE ' + QUOTENAME(@DestDB) + '.audit.ArchiveAuditLog
            SET EndTime = GETDATE(),
                Status = ''Error'',

...
/****** Object:  StoredProcedure [onprc_ehr].[ArchiveAuditTables]    Script Date: 6/21/2025 9:46:28 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [onprc_ehr].[ArchiveAuditTables]
AS
BEGIN
    SET NOCOUNT ON;

    -- Declare configurable variables
    DECLARE @SourceDB NVARCHAR(128) = 'Labkey_GJ',

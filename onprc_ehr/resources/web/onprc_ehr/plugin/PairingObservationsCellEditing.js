 ...
 */
Ext4.define('ONPRC_EHR.grid.plugin.PairingObservationsCellEditing', {
    extend: 'LDK.grid.plugin.CellEditing',
    alias: 'plugin.pairingobservationscellediting',
    ...
    getEditor: function(record, column) {
        ...
        var store = this.pairingobservationTypesStore;

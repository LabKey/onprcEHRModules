...
//Created: 1-18-2019  R.Blasa

Ext4.define('ONPRC_EHR.window.CreateTaskFromRecordsWindow', {
    ...
    statics: {
        ...
        createTaskFromRecordHandler: function(dataRegionName, formType, taskLabel){
            ...
            Ext4.create('ONPRC_EHR.window.CreateTaskFromRecordsWindow', {
    ...
    getAddToExistingItems: function(){
        return [{
            ...
            valueField: 'taskid',
            listConfig: {
                innerTpl: [LABKEY.Utils.encodeHtml('{rowid}: {title}')]
            },
            store: {
                type: 'labkey-store',
                schemaName: 'ehr',
    ...
    doAddToExisting: function(records){
        ...
        Ext4.Array.forEach(records, function(r, idx){
            toSave.push(Ext4.apply({
                taskid: taskId,
                QCState: 25,       //QCState: Scheduled    Modified: 1-11-2019  R.Blasa Set after adding to an existing task id
                formSort: idx
            }, r));
        }, this);

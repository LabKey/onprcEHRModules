 ...
 */
//  Created 2-2-2016  Blasa

Ext4.define('ONPRC_EHR.window.CopyFromRunsTemplateWindow', {
    ...
    onLoad: function(results){
        ...
        var toAdd= [{
            ...
            html: '<b>Performed by</b>'                //Added 11-20-2015 Blasa
        },{
        ...
        target.add({
            ...
            layout: {
                type: 'table',
                columns: 6                     //Added 11-20-2015 Blasa
            },
            defaults: {
                border: false,
                height: '15px',
            ...
            if (item.boundRecord){
                ...
                Ext4.Array.forEach(rows, function(row){
                    var data = {
                        ...
                        date: item.boundRecord.get('date'),   //Modified 2-5-2016 Blasa date format
                        servicerequest: item.boundRecord.get('servicerequested'),  //Added 12-28-2015 Blasa    Microbiology Results Only
                        runid: item.boundRecord.get('objectid')   ,
                        performedby: item.boundRecord.get('performedby')   //Added 11-20-2015 Blasa
                    };

        ...
        Ext4.Array.forEach(orderedKeys, function(key){
            ...
            if (flags){
                Ext4.Array.forEach(flags, function(f){
                    if ((f['flag/category'] == 'Alert' || f['flag/category'] == 'Flag') && (f['flag/value'] ) && (f['flag/value'].match(/Ketamine/i) || (f['flag/value'].match(/Sedation/i)) || f['flag/value'].match(/Telazol/i))){

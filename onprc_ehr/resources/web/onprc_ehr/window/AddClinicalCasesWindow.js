...
Ext4.define('EHR.window.AddClinicalCasesWindow', {
    ...
    getCases: function(button){
        ...
        LABKEY.Query.selectRows({
            ...
            columns: 'Id,Id/curLocation/location,objectid,mostRecentP2,Id/Utilization/use,problemCategories,mostRecentCeg_Plan',
    ...
    onSuccess: function(results){
        ...
        Ext4.Array.each(results.rows, function(sr){
            ...
            var obj = {
                ...
                remark: null,
                CEG_Plan: row.getValue('mostRecentCeg_Plan'),    //Added: 10-24-2017  R.Blasa

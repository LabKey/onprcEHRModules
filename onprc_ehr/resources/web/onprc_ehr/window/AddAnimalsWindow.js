...
Ext4.define('EHR.window.AddAnimalsWindow', {
    ...
    animalGroupHandler: function(){
        ...
        form.removeAll();
        form.add([{
            html: 'This will return any animals currently assigned to the selected group. You are allowed to choose more than one animal gropu at a time.',
            style: 'padding-bottom: 10px;'
        },{
            xtype: 'onprc_ehr-animalgroupfield',
            multiSelect: true,
            emptyText: '',
            itemId: 'groupField'
        }]);
        ...
        form.getAnimals = function(){
            ...
            var filterArray = this.getBaseFilterArray().concat([
                LABKEY.Filter.create('groupId', group.join(';'), LABKEY.Filter.Types.EQUALS_ONE_OF),
...
EHR.DataEntryUtils.registerGridButton('ADDANIMALST', function(config){

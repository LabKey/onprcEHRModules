 ...
 * @cfg sourceStore
 */
Ext4.define('ONPRC_EHR.window.OpenSurgeryCasesWindow', {
    ...
    onLoad: function(ids, demographicsMap){
        ...
        for (var id in animalMap){
            ...
            toAdd.push({
                ...
                width: 250,
                rowIdx: rowIdx,
                value: caseRec ? ((caseRec.remark ? (caseRec.remark + '\n' + Ext4.Date.format(new Date(), LABKEY.extDefaultDateFormat) + ': ') : '') + obj.procedureNames.join(', ')) : 'Open Sx Case: ' + obj.procedureNames.join(', ')
            });
...
EHR.DataEntryUtils.registerDataEntryFormButton('OPENSURGERYCASEST', {
    text: 'Open Cases',

...
// Created: 10-4-2017  R.Blasa


Ext4.define('onprc_ehr.window.SurgeryPostOpMedsWindow', {
...
EHR.DataEntryUtils.registerGridButton('SURGERYMEDS', function(config){
    ...
    return Ext4.Object.merge({
        ...
        handler: function(btn){
            ...
            Ext4.create('onprc_ehr.window.SurgeryPostOpMedsWindow', {

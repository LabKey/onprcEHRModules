...
Ext4.define('ONPRC_EHR.panel.ManageCasesPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.onprc_ehr-managecasespanel',
                ...
                handler: function(view, rowIndex, colIndex, item, e, rec){
                    Ext4.create('Ext.menu.Menu', {
                        items: [{
                            ...
                            handler: function(btn){
                                Ext4.create('Ext.window.Window', {
                                    ...
                                    items: [{
                                        ...
                                        value: new Date(), //Modified: 10-09-2018  R.Blasa  restored to original code
                                        minValue: rec.get('date'),
                                        maxValue: new Date() //Modified: 10-09-2018  R.Blasa  restored to original code
                                    }],
                                    buttons: [{
                                        text: 'Close Case',
                                        scope: this,
                            ...
                            handler: function(btn){
                                Ext4.create('Ext.window.Window', {
                                    ...
                                    items: [{
                                        ...
                                        minValue: new Date(),  //Modified: 10-09-2018  R.Blasa  restored to original code
                                        value: rec.get('reviewdate') || Ext4.Date.add(new Date(), Ext4.Date.DAY, 14)  //Modified: 10-09-2018  R.Blasa  restored to original code
                                    }],
                                    buttons: [{
                                        text: 'Submit',
                                        scope: this,
                            ...
                            scope: this,
                            handler: function(btn){
                                this.up('onprc_ehr-managecasespanel').showEditCaseWindow(rec);
                            }
                        }]
                    }).showAt(e.getXY());
                }
        ...
        Ext4.apply(this, {
            ...
            items: [{
                ...
                items: [{
                    ...
                    itemId: 'assignedvet',
                    allowBlank: ONPRC_EHR.panel.ManageCasesPanel.CASE_CATEGORIES[this.boundRecord.get('category')].requiredFields.indexOf('assignedvet') == -1,
                    width: 560,
                    ...
                    fieldLabel: 'Reopen Date',
                    itemId: 'reviewdate',
                    allowBlank: ONPRC_EHR.panel.ManageCasesPanel.CASE_CATEGORIES[this.boundRecord.get('category')].requiredFields.indexOf('reviewdate') == -1,
                    width: 560,
                    ...
                    allowBlank: ONPRC_EHR.panel.ManageCasesPanel.CASE_CATEGORIES[this.boundRecord.get('category')].requiredFields.indexOf('remark') == -1,
                    width: 560,
                    height: 75,
...
Ext4.define('EHR.window.OpenCaseWindow', {
        ...
        Ext4.apply(this, {
            ...
            items: [{
                ...
                items: [{
                    ...
                    fieldLabel: 'Assigned Vet',
                    name: 'assignedvet',
                    value: ONPRC_EHR.panel.ManageCasesPanel.CASE_CATEGORIES[this.caseCategory].showAssignedVet ? this.defaultVet : null,
                    allowBlank: ONPRC_EHR.panel.ManageCasesPanel.CASE_CATEGORIES[this.caseCategory].requiredFields.indexOf('assignedvet') == -1,
                    hidden: !ONPRC_EHR.panel.ManageCasesPanel.CASE_CATEGORIES[this.caseCategory].showAssignedVet
                },{
                    xtype: 'labkey-combo',
                    fieldLabel: 'Problem',
                    allowBlank: ONPRC_EHR.panel.ManageCasesPanel.CASE_CATEGORIES[this.caseCategory].requiredFields.indexOf('problem') == -1,
                    anyMatch: true,
                    queryMode: 'local',
                    forceSelection: true,
                    name: 'problem',
                    ...
                    allowBlank: ONPRC_EHR.panel.ManageCasesPanel.CASE_CATEGORIES[this.caseCategory].requiredFields.indexOf('subcategory') == -1,
                    valueField: 'value',
                    displayField: 'value',
                    itemId: 'subcategory',
                    name: 'subcategory',
                    ...
                    allowBlank: ONPRC_EHR.panel.ManageCasesPanel.CASE_CATEGORIES[this.caseCategory].requiredFields.indexOf('remark') == -1,
                    height: 75
                }]
            }],
            buttons: [{
                ...
                handler: function(btn){
                    var win = btn.up('window');
                    win.doSave();  //Modified: 12-20-2017  R.Blasa  restored to original code
                }
            },{
                ...
                menu: [{
                    ...
                    handler: function(btn){
                        var win = btn.up('window');
                        win.doSave(new Date()); //Modified: 12-20-2017  R.Blasa  restored to original code
    ...
    doSave: function(enddate, reviewdate){
        ...
        values.date = new Date();  //Modified: 10-08-2018  R.Blasa  restored to original code
    ...
    initComponent: function(){
        Ext4.apply(this, {
            ...
            items: [{
                ...
                //Modified: 10-5-2018  R. Blasa filter array changes
                listeners: {
                    change: function(field, val){
                        var sc = field.up('panel').down('#subcategory');
                        var initialValue = sc.getValue();
                        sc.store.filterArray = [LABKEY.Filter.create('category', val),LABKEY.Filter.create('date_disabled', null, LABKEY.Filter.Types.ISBLANK)];
                        sc.store.load({
                            scope: this,
                            callback: function(){
                                if (initialValue){
                ...
                itemId: 'dateField',
                maxValue: new Date(), //Modified: 10-08-2018  R.Blasa  restored to original code

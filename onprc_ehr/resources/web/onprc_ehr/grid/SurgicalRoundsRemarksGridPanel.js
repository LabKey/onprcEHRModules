 ...
 */
Ext4.define('ONPRC_EHR.grid.SurgicalRoundsRemarksGridPanel', {
    extend: 'EHR.grid.Panel',
    alias: 'widget.onprc_ehr-surgroundsremarksgridpanel',
    ...
    getRowEditorPlugin: function(){
        ...
        this.rowEditorPlugin = Ext4.create('ONPRC_EHR.plugin.SurgicalRemarksRowEditor', {
            cmp: this
        });
                ...
                if (this.obsStore){
                    ...
                    data.each(function(r){
                        ...
                        if (!Ext4.isEmpty(r.get('inflammation'))){
                              line += ';' + r.get('inflammation') + ' Inflammation';
                        }

                        if (!Ext4.isEmpty(r.get('bruising'))){
                              line += ';' +r.get('bruising') + ' Bruising';
                        }
                        if (!Ext4.isEmpty(r.get('other'))){
                             line += ';' + r.get('other') + ' Other';
                        }

                        if (r.get('remark')){
                            line +=  ';' + r.get('remark') + ' Remark';
                        }

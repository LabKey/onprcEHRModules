            ...
            tpl: new Ext4.XTemplate(
                '<tpl if="TotalCount != undefined">',
                    ...
                    '<div class="order-dashboard-section order-dashboard-summary">',
                        ...
                        '<div class="order-dashboard-item">Pending Orders: <a href="{MissingConfirmationNumHref}">{MissingConfirmationNum:htmlEncode}</a></div>',
                        '<div class="order-dashboard-item">Orders Received: <a href="{ReceivedOrdersHref}">{ReceivedOrders:htmlEncode}</a></div>',
                    ...
                    '<tpl if="UserCanUpdate">',
                        '<div class="order-dashboard-section order-dashboard-summary">',
                            ...
                            '<div class="order-dashboard-item">Pending Orders Waiting for Confirmation: <a href="{MissingConfirmationNumHref}">{MissingConfirmationNum:htmlEncode}</a></div>',
                            '<div class="order-dashboard-item">Enter Order Receiving Details: <a href="{MissingReceivedDateHref}">{ToBeReceivedOrders:htmlEncode}</a></div>',
                            '<br>',
